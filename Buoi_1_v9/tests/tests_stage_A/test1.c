...
#include "timeline.h" // Thêm include cho timeline.h
...
int main() {
    ...
    timeline_init(); // Thêm dòng này để khởi tạo timeline

    printf("\n===== PRINTING BOOK AND USER INFORMATION =====\n");
    printf("INFOR Book 1:\n");
    ...
    printf("\n================NO TRANSACTION IS AVAILABLE NOW========================\n");
    transaction_print_active(transactions, transaction_count);
    printf("\n==NO TRANSACTION IS AVAILABLE NOW BECAUSE THEY ARE ALL RETURN/DELETED==\n");
    printf("\n=======================================================================\n");


    // Demonstrate the effect of is_deleted
    printf("\n===== DEMONSTRATING DELETED STATUS =====\n");
    // Changed function call to use pointer instead of array
    ...
    transaction_borrow(transactions, &transaction_count, &books[8], &users[0]); 
    
    printf("\n[DEMO] Active transactions after deleting Book 1 and User 1:\n");
    transaction_print_active(transactions, transaction_count); 
    printf("\n==NO TRANSACTION IS AVAILABLE NOW BECAUSE THEY ARE ALL DELETED==\n");
    printf("\nCANNOT PRINT Book 1 and User 1 since they are deleted==\n");


    printf("\n[DEMO] PRINT ALL TRANSACTION HISTORY OF USER 1( DELETED) =====\n");
    transaction_print_user_history(transactions, transaction_count, &users[0]); 

    printf("\n[DEMO] PRINT ALL TRANSACTION HISTORY OF USER 2( DELETED) =====\n");
    transaction_print_user_history(transactions, transaction_count, &users[1]); 
